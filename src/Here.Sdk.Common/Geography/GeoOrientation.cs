...
{
    /// <summary>Bearing in degrees, normalised to [0, 360). <c>null</c> if unknown.</summary>
    ...
    /// <summary>Initializes a new <see cref="GeoOrientation"/>, normalising bearing and clamping tilt/roll.</summary>
