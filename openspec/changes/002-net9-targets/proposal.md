...
`Here.Sdk.Common` only. Downstream repos (Abstractions, Core, etc.) each carry their own symmetric proposal.
...
- `Here.Sdk.Abstractions/002-net9-targets` — symmetric.
- `Here.Sdk.Core/002-net9-targets` — symmetric.
