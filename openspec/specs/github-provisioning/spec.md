...
Documents the GitHub repository setup, branch protection rulesets, NuGet API key scoping,
required secrets, and `nuget-production` environment for `Here.Sdk.Common`, all applied
idempotently via `build/setup-github.sh`.
