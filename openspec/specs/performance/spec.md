...
Sets binary size budget, hot-path allocation constraints, BenchmarkDotNet regression gates,
AOT/trim friendliness requirements, and deterministic build configuration for `Here.Sdk.Common`.
